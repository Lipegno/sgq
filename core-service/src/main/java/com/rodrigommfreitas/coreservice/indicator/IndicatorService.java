...
public class IndicatorService {
    ...
    private IndicatorYearResponse mapToResponse(IndicatorYear iy) {
        return new IndicatorYearResponse(
                ...
                iy.getIndicator().getFrequency() != null ? iy.getIndicator().getFrequency().name() : null,
        ...
        return indicatorYearRepository.findByYearId(yearId)
                ...
                .map(indicatorYear -> {
                    ...
                    return new IndicatorFullResponse(
                            ...
                            indicatorYear.getIndicator().getValueType() != null ? indicatorYear.getIndicator().getValueType().name() : null,
